      ...
      <div className="flex flex-wrap gap-y-6">
        ...
        <div className="w-full md:w-3/5">
          <div className="flex flex-col bg-neutral-50 rounded-md shadow-md h-full p-3 md:p-6">
            ...
            <div className="mb-auto">{product.summary}</div>

            <div className="w-full flex justify-between items-center sticky bottom-0 md:relative ">
              <div className="font-bold text-lg text-gray-800 flex flex-wrap items-center">
                <div>قیمت دوره : </div>
                {product.discount > 0 ? (
              ...
              <button className="w-fit rounded-md bg-lime-600 px-5 py-3 text-center text-sm font-semibold text-white hover:bg-lime-500">
                ثبت نام در دوره
              </button>
            </div>
          </div>
